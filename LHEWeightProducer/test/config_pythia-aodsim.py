...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:output-aodsim.root'),
...
from WSUAnalysis.LHEWeightProducer.lheWeightProducer_cfi import MGWeightsFromLHE
...
process.digi2raw_step = cms.Path(process.DigiToRaw + process.MGWeights) #added here
